...
import { xml_change_schedule, xml_odds_change_detail, xml_schedule } from "../middleware/changeXML.js";
...
export const scheduleCron = async () => {
    ...
    // Lập lịch chạy mỗi 2 phút
    schedule.scheduleJob("every-2-minute", "*/2 * * * *", async () => {
